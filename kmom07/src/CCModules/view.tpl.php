...
<tbody>
  <tr><td>Part of Cloudchaser Core modules</td><td><?=$module['isCloudchaserCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of Cloudchaser CMF modules</td><td><?=$module['isCloudchaserCMF']?'Yes':'No'?></td></tr>
