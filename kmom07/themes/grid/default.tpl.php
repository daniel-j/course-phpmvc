...
<div id='outer-wrap-header'>
  <div id='inner-wrap-header'>
    <div id='header'>
      ...
      <div id='banner'>
        <a href="http://psalm-sinatra.deviantart.com/art/Cloud-Chaser-318093871" target="_blank"><img src="<?=theme_url("/img/cloudchaser_cloud.png")?>" id="header-img"></a>
        <span id="site-title"><a href="<?=create_url("")?>"><?=$header?></a></span>
      </div>
