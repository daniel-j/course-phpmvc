...
EOD;
  ...
  private function Debug() {
	  $html = "<hr><h3>Debug information</h3><p>The content of the config array:</p><pre>" . htmlentities(print_r($this->config, true)) . "</pre>";
	  $html .= "<p>The content of the data array:</p><pre>" . htmlentities(print_r($this->data, true)) . "</pre>";
	  $html .= "<p>The content of the request array:</p><pre>" . htmlentities(print_r($this->request, true)) . "</pre>";
	  $this->data['main'] .= $html;
  }
  ...
  private function Menu() {
    ...
    $html = "";
    foreach($menu as $val) {
      $html .= "<li>".$this->request->CreateLink($val, $val)."</li>\n";  
    }
...
<p>Here is the content of the controller, including properties from CObject which holds access to common resources in CCloudChaser.</p>
EOD;
