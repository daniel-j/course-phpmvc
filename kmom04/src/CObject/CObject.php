<?php
/**
 * Holding a instance of CCloudchaser to enable use of $this in subclasses and provide some helpers.
 *
...
class CObject {
  ...
  /**
   * Constructor, can be instantiated by sending in the $cc reference.
   */
  protected function __construct($cc=null) {
    if(!$cc) {
